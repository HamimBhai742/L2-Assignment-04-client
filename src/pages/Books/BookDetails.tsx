    ...
    <div className='min-h-screen bg-gradient-to-br from-green-50 to-green-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-6 sm:p-8'>
      <Card className='w-full max-w-3xl rounded-2xl shadow-2xl dark:bg-gray-900'>
        <CardContent className='p-6 sm:p-8'>
          <h1 className='text-2xl sm:text-4xl font-bold mb-4 sm:mb-6 text-center text-green-800 dark:text-green-300'>
            📚 {book.title}
          </h1>

          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-base sm:text-lg text-gray-700 dark:text-gray-300'>
